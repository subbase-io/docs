...
<Steps>
  ...
  <Step title="Set Tax Codes">
    If applicable for your order type, select the appropriate tax code for the order. The tax code selector appears based on your company settings and order type.
  </Step>
